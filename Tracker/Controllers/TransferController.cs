...
namespace TrackerApp.Controllers
{
    ...
    public class TransferController : Controller
    {
        ...
        public TransferController(TrackerAppBDContext context, 
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var trackerAppContext = _context.Movement
                ...
                .Include(m => m.Status);
            */
            return View(await _servicio.GetAllByMovementType(3));
        }
        ...
        {
            movement.MovementTypeId = 3;

            if (ModelState.IsValid)
            {
                _servicio.AddTransfer(movement);
                    ...
                    "ParentMovementId,IsShared,PayMovementId,StatusId")] MovementDtoRequest movement)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    _servicio.UpdateTransfer(movement);
                }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            if (movement != null)
            {
                _servicio.RemoveTransfer(movement);
            }
            return RedirectToAction(nameof(Index));
        }
