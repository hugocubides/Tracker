...
namespace TrackerApp.Controllers
{
    ...
    public class IncomeController : Controller
    {
        ...
        public IncomeController(TrackerAppBDContext context, 
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var trackerAppContext = _context.Movement
                ...
                .Include(m => m.Status);
            */
            return View(await _servicio.GetAllByMovementType(1));
        }
                    ...
                    "ParentMovementId,IsShared,PayMovementId,StatusId")] MovementDtoRequest movement)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    _servicio.UpdateIncome(movement);
                }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            if (movement != null)
            {
                _servicio.RemoveIncome(movement);
            }
            return RedirectToAction(nameof(Index));
        }
